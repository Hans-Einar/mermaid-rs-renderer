...
utvides teksthindringen mot eiersegmentet, men stopper én hindringsmargin pluss
en liten numerisk toleranse fra segmentet. Hindringer er globale i libavoid;
