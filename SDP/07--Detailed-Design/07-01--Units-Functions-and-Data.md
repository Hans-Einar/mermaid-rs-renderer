...
## Function contracts (planned symbols)
...
| DefineWidgets / WidgetRegistry | trusted definitions registered once -> unique kind/version with property/event/measurement descriptors; duplicate registration rejects |
...
These names allocate roles, not installed API symbols. Library/host allocation
is separate from SDL containment; BoxUiLibrary remains a library. No C++ class
